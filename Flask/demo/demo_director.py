...
def clean_slate(use_new_keys=False):
  ...
  for vin in KNOWN_VINS:
    ...
    # director_service_instance.vehicle_repositories[vin].timestamp.expiration = datetime.datetime(2022, 5, 2, 11, 11)
  # repo.timestamp.expiration = datetime.datetime(2022, 5, 2, 11, 11)
  ...
  for vin in inventory.ecus_by_vin:
    for ecu in inventory.ecus_by_vin[vin]:
      add_target_to_director(
          ...
          ecu)
      print('\n\n\n\n',vin,ecu)
  print(LOG_PREFIX + 'Signing and hosting initial repository ')
