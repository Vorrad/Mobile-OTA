...
def update_cycle():
  ...
  if image is None:
    ...
    generate_signed_ecu_manifest()
    submit_ecu_manifest_to_primary()
    ecu_result = "request_primary_fail"
    return ecu_result
